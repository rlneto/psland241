...
function App() {
  ...
  const changeFaseHandler = (event, newValue) => { // A ordem no nome foi alterada para indicar que esse handler e o próximo são usados nos sliders
    setFase(newValue);
  ...
  const inglesChangeHandler = () => {
    ...
    if (respostas.idiomas.includes(inglesRef.current.value)) {
      setRespostas({...respostas, idiomas: respostas.idiomas.filter((item) => item !== inglesRef.current.value)});
    }
    else {
      setRespostas({...respostas, idiomas: [...respostas.idiomas, inglesRef.current.value]});
    }
  }
  const mandarimChangeHandler = () => {
    mandarimRef.current.value = 'Mandarim';
    if (respostas.idiomas.includes(mandarimRef.current.value)) {
      setRespostas({...respostas, idiomas: respostas.idiomas.filter((item) => item !== mandarimRef.current.value)});
    }
    else {
      setRespostas({...respostas, idiomas: [...respostas.idiomas, mandarimRef.current.value]});
    }
  }
  const espanholChangeHandler = () => {
    espanholRef.current.value = 'Espanhol';
    if (respostas.idiomas.includes(espanholRef.current.value)) {
      setRespostas({...respostas, idiomas: respostas.idiomas.filter((item) => item !== espanholRef.current.value)});
    }
    else {
      setRespostas({...respostas, idiomas: [...respostas.idiomas, espanholRef.current.value]});
    }
  }
  ...
  const javascriptChangeHandler = () => {
    ...
    if (respostas.tecnologias.includes(javascriptRef.current.value)) {
      setRespostas({...respostas, tecnologias: respostas.tecnologias.filter((item) => item !== javascriptRef.current.value)});
    }
    else {
      setRespostas({...respostas, tecnologias: [...respostas.tecnologias, javascriptRef.current.value]});
    }
  }
  ...
  const nodejsChangeHandler = () => {
    ...
    if (respostas.tecnologias.includes(nodejsRef.current.value)) {
      setRespostas({...respostas, tecnologias: respostas.tecnologias.filter((item) => item !== nodejsRef.current.value)});
    }
    else {
      setRespostas({...respostas, tecnologias: [...respostas.tecnologias, nodejsRef.current.value]});
    }
  }
  ...
  const reactChangeHandler = () => {
    ...
    if (respostas.tecnologias.includes(reactRef.current.value)) {
      setRespostas({...respostas, tecnologias: respostas.tecnologias.filter((item) => item !== reactRef.current.value)});
    }
    else {
  ...
  const frontendChangeHandler = () => {
    ...
    if (respostas.interesse.includes(frontendRef.current.value)) {
      setRespostas({...respostas, interesse: respostas.interesse.filter((item) => item !== frontendRef.current.value)});
    }
    else {
      setRespostas({...respostas, interesse: [...respostas.interesse, frontendRef.current.value]});
    }
  }
  ...
  const backendChangeHandler = () => {
    ...
    if (respostas.interesse.includes(backendRef.current.value)) {
      setRespostas({...respostas, interesse: respostas.interesse.filter((item) => item !== backendRef.current.value)});
    }
    else {
      setRespostas({...respostas, interesse: [...respostas.interesse, backendRef.current.value]});
    }
  }
  ...
  const gestaoChangeHandler = () => {
    ...
    if (respostas.interesse.includes(gestaoRef.current.value)) {
      setRespostas({...respostas, interesse: respostas.interesse.filter((item) => item !== gestaoRef.current.value)});
    }
    else {
      setRespostas({...respostas, interesse: [...respostas.interesse, gestaoRef.current.value]});
    }
  }
  ...
  const gerenciaChangeHandler = () => {
    ...
    if (respostas.interesse.includes(gerenciaRef.current.value)) {
      setRespostas({...respostas, interesse: respostas.interesse.filter((item) => item !== gerenciaRef.current.value)});
    }
    else {
      setRespostas({...respostas, interesse: [...respostas.interesse, gerenciaRef.current.value]});
    }
  }
  ...
  const vendasChangeHandler = () => {
    ...
    if (respostas.interesse.includes(vendasRef.current.value)) {
      setRespostas({...respostas, interesse: respostas.interesse.filter((item) => item !== vendasRef.current.value)});
    }
    else {
      setRespostas({...respostas, interesse: [...respostas.interesse, vendasRef.current.value]});
    }
  }
  ...
  const giChangeHandler = () => {
    ...
    if (respostas.diretorias.includes(giRef.current.value)) {
      setRespostas({...respostas, diretorias: respostas.diretorias.filter((item) => item !== giRef.current.value)});
    }
    else {
      setRespostas({...respostas, diretorias: [...respostas.diretorias, giRef.current.value]});
    }
  }
  ...
  const comercialChangeHandler = () => {
    ...
    if (respostas.diretorias.includes(comercialRef.current.value)) {
      setRespostas({...respostas, diretorias: respostas.diretorias.filter((item) => item !== comercialRef.current.value)});
    }
    else {
      setRespostas({...respostas, diretorias: [...respostas.diretorias, comercialRef.current.value]});
    }
  }
  ...
  const projetosChangeHandler = () => {
    ...
    if (respostas.diretorias.includes(projetosRef.current.value)) {
      setRespostas({...respostas, diretorias: respostas.diretorias.filter((item) => item !== projetosRef.current.value)});
    }
    else {
      setRespostas({...respostas, diretorias: [...respostas.diretorias, projetosRef.current.value]});
    }
  }
  ...
  const marketingChangeHandler = () => {
    ...
    if (respostas.diretorias.includes(marketingRef.current.value)) {
      setRespostas({...respostas, diretorias: respostas.diretorias.filter((item) => item !== marketingRef.current.value)});
    }
    else {
      setRespostas({...respostas, diretorias: [...respostas.diretorias, marketingRef.current.value]});
    }
  }
  ...
  const presidenciaChangeHandler = () => {
    ...
    if (respostas.diretorias.includes(presidenciaRef.current.value)) {
      setRespostas({...respostas, diretorias: respostas.diretorias.filter((item) => item !== presidenciaRef.current.value)});
    }
    else {
      setRespostas({...respostas, diretorias: [...respostas.diretorias, presidenciaRef.current.value]});
    }
  }
  ...
  const dhoChangeHandler = () => {
    ...
    if (respostas.diretorias.includes(dhoRef.current.value)) {
      setRespostas({...respostas, diretorias: respostas.diretorias.filter((item) => item !== dhoRef.current.value)});
    }
    else {
      setRespostas({...respostas, diretorias: [...respostas.diretorias, dhoRef.current.value]});
    }
            ...
            <Grid container spacing={1} direction="row" justifyContent="left" alignItems="center" >
              ...
              <Grid item xs={12} sm={12} md={12} sx={{mb : 2}}>
                ...
                onChange={oitohorasChangeHandler}>
                  <FormControlLabel value="Quatro" control={<Radio />} label="Quatro" />
                ...
                onChange={inclusaoChangeHandler}>
                  <FormControlLabel value="Faturamento" control={<Radio />} label="Faturamento" />
